...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 24 22:36:27 2020

@author: camilavillalobos
"""
...
for idx, linea in enumerate(Lineas):
    ...
    if line[0] not in instructions:
        ...
        if line[1][0] == "(":
            print("Error en la linea {}: {} \tPara la instrucción ADD no existe el uso con (Dir), 'algo'".format(idx + 1, linea, line[0]))
